...
module add torchvision/0.10.0-fosscuda-2021a-Python-3.8.2
module add pytorch/2.0.0-python-3.9
# module add pytorch/1.9.0-fosscuda-2021a-Python-3.8.2
module add OpenCV/4.5.3-fosscuda-2021a-Python-3.8.2
module add opencv-python
module add matplotlib
module add scikit-learn
module add tqdm
python3 create_filterbank.py
