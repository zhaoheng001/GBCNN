...
class _FilterBank(object):
    def __init__(self):
        ...
        self.pdefine = self.get_fb("pdefine", [(5, 5)])
        self.pdct = self.get_fb("pdct", [(5, 5)])
...
class _ConvNdRF(_ConvNd):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride,
        ...
        self.gain = gain
        # print(self.gain)
        if self.fbank_type not in ["nn_bank", "frame", "pframe", "pdefine", "pdct"]:
            raise ValueError(f"fbank_type values must be one of the following: 'nn_bank', 'frame', 'pframe' , 'pdefine', 'pdct"
    ...
    def get_filterbank(self, ):
        #ftbank = np.load("/project/labate/heng/inpainting-partial-conv/convrf/5x5_SDPFdict.npy")
        #return ftbank
